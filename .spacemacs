...
you should place your code here."
  ...
  ;; a desperate attempt to configure for better js
 ...
 ;; (define-key tern-mode-keymap (kbd "M-,") nil)
  ...
  (flycheck-add-mode 'javascript-eslint 'rjsx-mode-hook)
